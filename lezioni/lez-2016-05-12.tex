...
\marginpar{Per quanto ci sia scritto alternativa non ha un bel nulla di alternativo, ad eccezione del fatto, necessario, degli incroci multipli. Propongo un merge con la precedente (Ale)}
...
\end{proof}
\footnotetext{Il procedimento di ortogonalizzazione è indipendente dalla caratteristica del campo(spero, toglierò queste parentesi non appena avrò controllato, Ale)}
