...
\marginpar{potremmo definire cos'è un punto aderente per snellire i passaggi successivi -AeB}
...
\begin{proof}
	...
	\end{description}
\end{proof}
%magari con un disegno è veramente immediato, ma non ho voglia di farlo -AeB
...
\begin{es}
	...
	\begin{itemize}
		...
		\footnotetext{Per la definizione di topologia quoziente si veda la fine del capitolo.}
	\end{itemize}
\end{es}
