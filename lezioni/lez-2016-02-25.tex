...
\begin{proof}
	Sia $X$ compatto e $\fundef XY$ continua.
	Vogliamo dimostrare che $f(X)$ con la topologia di sottospazio è compatto.
	...
	gli elementi di $\mathcal A_X$ sono aperti,
	mentre per ragioni insiemistiche ricoprono $X$.
	Allora da $\mathcal A_X$ posso estrarre un sottoricoprimento finito $\mathcal A_X^F$.
	Tornando indietro,
	l'insieme $\setdef[f(A)]{A\in\mathcal A_X^F}$ è un sottoricoprimento finito di $\mathcal A$.
\end{proof}
...
\begin{fat}
	...
	\marginpar{Non si propaga anche $T_2$?Risposta: NO!}
\end{fat}
