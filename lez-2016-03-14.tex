% autore: Candido
% quando si toglierà questa divisione in lezioni alcune sezioni e sottosezioni dovranno cambiare status, scrivo accanto cosa diventeranno
\titlet{Fibrato tangente} %promozione a section

\subsubsection{Modello locale} %promozione a subsection~titlet
...
\subsubsection{Caratterizzazione differenziale di $T_x U$} %promozione a subsection~titlet
...
\subsubsection{Costruzione del fibrato tangente su varietà differenziabili} %promozione a titlet~subsection
