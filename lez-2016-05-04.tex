...
\marginpar{La notazione usata è forse non corretta: volevo scrivere in modo formale il fatto che la mappa associasse ad un punto un vettore (un elemento del tangente). La componente "vettoriale" è solo la seconda dopo il prodott cartesiano}
\end{proof}
\begin{oss}
