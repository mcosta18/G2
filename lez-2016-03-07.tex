...
\begin{teo}[Funzione implicità, v. surgettiva]
\noindent \\Definisco prima un \emph{modello locale lineare}, ovvero una proiezione $\fundef[\pi]{\R^n}{\R^m}$ con $n \ge m$ tale che $j(x_1,\cdots,x_n)=(x_1,\cdots,x_m)$. Noto che $\forall x \in \R^n, d_xj$ è iniettivo (essendo $d_xj=j(x)$ per linearità di $j$).\\
...
\begin{teo}[Funzione implicità, v. iniettiva]
\noindent \\Definisco prima un \emph{modello locale lineare}, ovvero una inclusione $\fundef[j]{\R^n}{\R^m}$ con $n \le m$ tale che $\pi(x_1,\cdots,x_n)=(x_1,\cdots,x_n,0,0,\cdots)$. Noto che $\forall x \in \R^n, d_xj$ è surgettivo (essendo $d_xj=j(x)$ per linearità di $j$).\\
...
\begin{prop}
Sia $\fundef{\R^n}{\R^n}$ un generico diffeomorfismo. Lla composizione del differenzenziale $\fundef[df]{\R^n}{GL_n(\R)}$, del determinante $\fundef[det]{GL_n(\R)}{\R\textbackslash\{0\}}$ e della funzione segno $\fundef[sgn]{\R\textbackslash\{0\}}{\{\pm1\}}$: $sgn \circ det \circ df$ è una funzione costante che può valere $1$ o $-1$.
\end{prop}

\begin{proof}
$\R^n$ è connesso e $sgn \circ det \circ df$ è composizione di funzioni continue, quindi continua.
\end{proof}
