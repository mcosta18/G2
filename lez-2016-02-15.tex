...
\item Siano $A_1,\ldots,A_n$ sottoinsiemi di $X$. Considero l'intersezione $\inters A_k$ di tutti gli insiemi $A$. Per ogni punto $x$ nell'intersezione considero tutti gli $A_n$ tali che $x \in A_n$. Prendo quindi una palla aperta $B^n(x)$ per ognuno di questi (posso farlo per definizione di $\tau_d$).
...
\item se $x \in \union A_j$ allora $x$ appartiene almeno ad uno degli $A_k$. Poichè questi sono aperti segue che  $\exists \ball[\tilde r]x \subseteq A_k \subseteq \union A_j$. \qedhere
\end{itemize}
\end{proof}
...
\begin{defn}[Intorno]
Dato $x \in (X,\tau)$, si dice \emph{intorno} di $x$ (rispetto a $\tau$) un insieme $U_x$ tale che $x \in U_x$ ed esiste un aperto $A$ tale che $x \in A \subseteq U_x$.
\end{defn}
