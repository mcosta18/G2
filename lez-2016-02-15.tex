...
\begin{proof}\noindent
\begin{itemize}
\item Sia $y \in \ball[r]x$, devo trovare un $r'$ tale che $\ball[r']x \subseteq \ball[r]x$. Prendo $r' < r-d(x,y)$. Segue dalla triangolare: \marginpar{cos'è la triangolare?}
...
\begin{defn}[Intorno]
Dato $x \in (X,\tau)$, si dice \emph{intorno} di $x$ (rispetto a $\tau$) un insieme $U_x$ tale che $x \in U$  e esiste un aperto $A$ tale che $x \in A \subseteq U_x$. \marginpar{usiamo $U_x$ o $U(x)$?}
\end{defn}
